...
export default {
  ...
  toolbarDefaultBg: Color.light_black.colorHalf,
  ...
  toolbarTextColor: Color.white.color08,
  toolbarDefaultBorder: Color.white.color02,
  ...
  // List
  listBg: "#000",
  listBorderColor: Color.light_black.colorHalf,
