...
const colors = {
    ...
    plannerFilterBackground: '#F4F6F7', //plannerFabButtonBackground
    plannerFilterText: '#000000', //plannerFabButtonText
    plannerFilterCloseIconBackground: '#FFF', //card
    plannerFilterCloseIconText: '#000000',
