...
class StackViewLayout extends React.Component {
  ...
  _panResponder = PanResponder.create({
    ...
    onMoveShouldSetPanResponder: (event, gesture) => {
      const {
        transitionProps: { navigation, layout, scene, scenes },
        mode
      } = this.props;
      const { index } = navigation.state;
      const isVertical = scenes[scene.index].descriptor.options.modal || false;
      const allScreenDismiss = scenes[scene.index].descriptor.options.allScreenDismiss || false;
      const { options } = scene.descriptor;
      ...
      if (screenEdgeDistance > gestureResponseDistance && !allScreenDismiss) {
